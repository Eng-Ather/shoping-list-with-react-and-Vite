...
<div class="card m-7 max-w-sm border border-yellow-900 rounded-lg ">
        <img class=" cardImage" src={item.images[0]} alt="product image" />
    <div class="px-5 pb-5">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{item.category.name}</h5>
